import { TELEGRAM_CHAT_ID, TELEGRAM_TOKEN } from '@/constants/seo.constants'
...
export function formatCurrency(amount: number) {
	return `${CURRENCY_FORMATTER.format(Math.floor(amount))} грн`
}
...
export const sendTelegramMessage = async ({ message }: { message: string }) => {
